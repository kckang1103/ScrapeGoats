...
def create_settings_json(settings_filename, query, until_date, since_date, tweets_per_interval):
    """
    ...
    settings_json['tweetsDesired'] = tweets_per_interval
...
def get_tweets(queries, intervals, tweets_per_interval):
    """
